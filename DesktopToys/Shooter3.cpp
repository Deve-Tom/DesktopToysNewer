...
CShooter3::CShooter3(){
	//载入图片
	m_vImgUp.push_back(Image::FromFile(_T("images/Eraser Ed 0.png")));
	m_vImgUp.push_back(Image::FromFile(_T("images/Eraser Ed 1.png")));
	m_vImgUp.push_back(Image::FromFile(_T("images/Eraser Ed 2.png")));
	m_vImgDown.push_back(Image::FromFile(_T("images/Eraser Ed 00.png")));
	m_vImgDown.push_back(Image::FromFile(_T("images/Eraser Ed 01.png")));
}
...
void CShooter3::Draw(Gdiplus::Graphics &gh){
	...
	case CShooter3::EStatus::EStatusLeftDown: {
		...
		if (index == 1) {
			//释放碎屑
			g_game->Append(std::make_shared<CShooter3Mark>(
