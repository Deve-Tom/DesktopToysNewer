...
CShooter0::CShooter0()
{
	...
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero 右.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero 右上.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero 上.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero 左上.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero 左.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero 左下.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero 下.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero 右下.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero Fire Path.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero Left Fire 00.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero Left Fire 01.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero Left Fire 02.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero Left Fire 03.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero Left Fire 04.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero Right Fire 00.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero Right Fire 01.png")));
	m_vImage.push_back(Image::FromFile(
		_T("images/Foton The Desktop Hero Right Fire 02.png")));
	m_vImage.push_back(Image::FromFile(
